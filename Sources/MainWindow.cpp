...
void MainWindow::DrawBoard()    //画游戏背景
{
    ...
    QPixmap BKPic(":/image/gameBG.jpg");
...
void MainWindow::StartTimer()   //连接自动移动函数及重绘函数，开始计时
{
    ...
    AutoMoveTimer->start(150);  //默认自动移动频率为1.5s/次
    KeyPressTimer->start(1);    //默认按键确认频率为1ms/次
}
...
void MainWindow::EatExFood()    //处理吃掉食物
{
    ...
    score+=3;   //大仓鼠+3分
    level=score/10+1;   //更新游戏等级
    SetLevel(level);    //根据等级调整难度
...
{
    ScoreBoardTitle=new QLabel(this);
...
void MainWindow::DrawScoreBoard()   //绘制计分板
{
    ...
    ScoreBoardTitle->setGeometry(640,-20,160,120);
    QFont ScoreBoardTitleFont;
    ScoreBoardTitleFont.setFamily("华文楷体");
    ScoreBoardTitleFont.setPointSize(35);
    ...
    CurrentScore->setGeometry(630,60,150,100);
    QFont CurrentScoreFont;
    CurrentScoreFont.setFamily("Monaco");
    CurrentScoreFont.setPointSize(20);
    ...
    TheBestScore->setGeometry(630,140,150,100);
    QFont TheBestScoreFont;
    TheBestScoreFont.setFamily("Monaco");
    TheBestScoreFont.setPointSize(20);
    ...
    CurrentDeathTime->setGeometry(630,215,150,100);
    QFont CurrentDeathTimeFont;
    CurrentDeathTimeFont.setFamily("Monaco");
    CurrentDeathTimeFont.setPointSize(20);
    ...
    CurrentLevel->setGeometry(620,290,160,100);
    QFont CurrentLevelFont;
    CurrentLevelFont.setFamily("Monaco");
    CurrentLevelFont.setPointSize(20);
